              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form className="w-full text-white">
                  ...
                  <div className="p-2 border sm:flex sm:items-center border-slate-300">
                    ...
                    <button
                      className="w-full h-12 px-6 py-3 mt-1 text-sm font-semibold tracking-wide uppercase bg-cyan-600 sm:ml-4 sm:flex-shrink-0 sm:w-auto sm:mt-0"
                      type="submit"
                    >
                      Sign Up
                    </button>
          ...
          <div className="pt-8 mt-12 border-t border-white/10">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              <p className="text-xs text-center text-gray-400 lg:text-left">
                Copyright &copy; {new Date().getFullYear()}. Stall. All
                rights reserved.
              </p>
